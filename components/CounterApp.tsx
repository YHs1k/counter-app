      ...
      {!isConnected ? (
        <div className="text-center">
          ...
          <button
            ...
            disabled={isLoading}
className="bg-indigo-500 hover:bg-indigo-600 disabled:bg-gray-400 text-white font-semibold py-2 px-5 rounded-xl shadow-md transition-transform hover:scale-105"
          >
